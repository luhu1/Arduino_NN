...
void network_train_batch_imgs(NeuralNetwork* net, char label[], Matrix* data[], int batch_size) {
...
float network_predict_imgs(NeuralNetwork* net, char label[], Matrix* data[], int n) {
	int n_correct = 0;
	for (int i = 0; i < n; i++) {
